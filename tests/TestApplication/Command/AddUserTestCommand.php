...
use App\UserInterface\Command\AddUserCommand;
use Generator;
 ...
 * @internal
 */
class AddUserTestCommand extends AbstractTestCommandIntegration
{
    /**
     * @var string[]
     */
    ...
    private function assertUserCreated(bool $isAdmin): void
    {
        ...
        self::assertTrue($passwordHasher->isPasswordValid($user, $this->userData['password']));
